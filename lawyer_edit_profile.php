														...
														<div class="form-row">
															...
															<div class="form-group col-md-3">
																...
																<select id="city" name="city" class="form-control">
																	...
																	<option value="Salem" <?php if ($row['city']=='Salem'){echo "selected";}?>>Salem</option>
																	...
																	<option value="Erode" <?php if ($row['city']=='Erode'){echo "selected";}?>>Erode</option>
																	<option value="Thanjavur" <?php if ($row['city']=='Thanjavur'){echo "selected";}?>>Thanjavur</option>
																	<option value="Vellore" <?php if ($row['city']=='Vellore'){echo "selected";}?>>Vellore</option>

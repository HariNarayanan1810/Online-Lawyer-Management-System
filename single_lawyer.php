						...
						<nav class="navbar navbar-expand-lg ">
							...
							<div class="collapse navbar-collapse" id="navbarSupportedContent">
								<ul class="navbar-nav ml-auto ">
									...
									<li class="">
										<a class="nav-link cus-a" href="index.php#about-us">About Us</a>
									</li>
									<?php if(isset($_SESSION['login']) && $_SESSION['login'] == TRUE){ ?>
										<li class="">
											<?php
												$dashboard = "user_dashboard.php";
												if(isset($_SESSION['role']) && $_SESSION['role'] == 'Lawyer') $dashboard = "lawyer_dashboard.php";
												if(isset($_SESSION['role']) && $_SESSION['role'] == 'Admin') $dashboard = "admin_dashboard.php";
											?>
											<a class="nav-link cus-a" href="<?php echo $dashboard; ?>">Dashboard</a>
										</li>
										<li class="">
					...
					<?php
						...
						<div class="col-md-3">
							<div class="sideprofile">
								<img src="images/upload/20230505190118_21104.png" class="img-fluid profile_img" alt="profile picture">
								...
								<form action="save_booking.php" method="post">
									<div class="row">
										...
										<div class="col-md-3 float-right">
											<?php if(isset($_SESSION['login']) && $_SESSION['login'] == TRUE && isset($_SESSION['client_id'])){ ?>
												...
												<h6>Only user accounts can request lawyer booking</h6>
												<?php }else{ ?>
